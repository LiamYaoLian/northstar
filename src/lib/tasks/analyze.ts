...
- recurrenceType 为 none | daily | weekly | monthly | quarterly | yearly：习惯/例行（晨跑、冥想、记账）倾向 daily；标题含具体周几用 weekly；每月固定日期用 monthly；每季度固定日期用 quarterly（recurrenceDays 为 [monthInQuarter, day]，monthInQuarter 1-3）；每年固定月日用 yearly（recurrenceDays 为 [calendarMonth, day]，calendarMonth 1-12）；一次性交付为 none
- recurrenceDays：weekly 填 1-7；monthly 填 1-31；quarterly 填 [monthInQuarter, dayOfMonth]；yearly 填 [calendarMonth, dayOfMonth]；其他为 null
